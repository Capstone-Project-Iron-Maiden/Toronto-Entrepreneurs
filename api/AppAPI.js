...
export function loadHomeData() {
    firebase.database().ref('/entrepeneurDBTO/homescreen').on('value', (snapshot) => {
...
export function loadScheduleData() {
  firebase.database().ref('/entrepeneurDBTO/schedulescreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadExhibitorData() {
  firebase.database().ref('/entrepeneurDBTO/exhibitorscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadSpeakerData() {
  firebase.database().ref('/entrepeneurDBTO/speakerscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadTicketData() {
  firebase.database().ref('/entrepeneurDBTO/ticketscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
